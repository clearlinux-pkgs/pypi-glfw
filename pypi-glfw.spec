...
Version  : 2.6.5
Release  : 14
URL      : https://files.pythonhosted.org/packages/a5/ec/f05fd918f82c572fe399b2a794c6c7ca6c92f4a93849e70cbc989927f91b/glfw-2.6.5.tar.gz
Source0  : https://files.pythonhosted.org/packages/a5/ec/f05fd918f82c572fe399b2a794c6c7ca6c92f4a93849e70cbc989927f91b/glfw-2.6.5.tar.gz
...
%prep
%setup -q -n glfw-2.6.5
cd %{_builddir}/glfw-2.6.5
pushd ..
cp -a glfw-2.6.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706200661
