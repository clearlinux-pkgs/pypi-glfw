...
Source0  : https://files.pythonhosted.org/packages/1f/fe/fd827e0e0babed43c08949644d1c2cafe5bc0f0ddcd369248eb27841c81c/glfw-2.7.0.tar.gz
...
%prep
%setup -q -n glfw-2.7.0
cd %{_builddir}/glfw-2.7.0
pushd ..
cp -a glfw-2.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708968008
