...
Source0  : https://files.pythonhosted.org/packages/38/97/a2d667c98b8474f6b8294042488c1bd488681fb3cb4c3b9cdac1a9114287/glfw-2.9.0.tar.gz
...
%prep
%setup -q -n glfw-2.9.0
cd %{_builddir}/glfw-2.9.0
pushd ..
cp -a glfw-2.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744741742
