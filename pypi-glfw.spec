...
Version  : 2.6.3
Release  : 11
URL      : https://files.pythonhosted.org/packages/89/8d/5d6b933aeb4891fb56acdc8473342f838f8552105b1a71b1364f7de5e1fb/glfw-2.6.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/89/8d/5d6b933aeb4891fb56acdc8473342f838f8552105b1a71b1364f7de5e1fb/glfw-2.6.3.tar.gz
...
%prep
%setup -q -n glfw-2.6.3
cd %{_builddir}/glfw-2.6.3
pushd ..
cp -a glfw-2.6.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700239289
